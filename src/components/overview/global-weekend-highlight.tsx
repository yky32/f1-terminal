  ...
  return (
    <Link
      ...
      className={cn(
        ...
        glassHover,
        glassFocus,
        "pointer-events-auto relative block max-w-[15.5rem] overflow-hidden rounded-[1.125rem] p-3.5 transition-[transform,opacity,filter] hover:-translate-y-0.5 sm:max-w-[17rem]",
        isLive && "global-weekend-highlight--live",
        isUpcoming && "global-weekend-highlight--upcoming",
        className,
      )}
    >
      {isUpcoming ? (
        <span
          className="pointer-events-none absolute inset-0 rounded-[inherit] bg-neutral-900/[0.045]"
          aria-hidden
        />
      ) : null}
